package frc.team4050.vision;

import frc.team4050.GUI;
...
public class Vision {
	...
	public void loop() {
		...
		GUI processedFrame = new GUI("Processed Frame", 400, 400, true, false);
		GUI augmentedFrame = new GUI("Augmented Frame", 400, 400, true, false);
